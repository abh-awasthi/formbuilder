<li class="form-element {#required}required{/required}" id="element-{position}" data-label="{label}" data-position="{position}" data-type="element-checkboxes">
	...
	<div class="choices" data-type="settings-choice-checkbox">
		...
		<div class="choice checkbox disabled">
		  <label>
		    <input type="checkbox" class="option-1 form-control" name="element-{position}-choice" value="First Choice" disabled>
		...
		<div class="choice checkbox disabled">
		  <label>
		    <input type="checkbox" class="option-2 form-control" name="element-{position}-choice" value="Second Choice" disabled>
		...
		<div class="choice checkbox disabled">
		  <label>
		    <input type="checkbox" class="option-3 form-control" name="element-{position}-choice" value="Third Choice" disabled>
